                    ...
                    <div class="col-md-12">
                        <form action="" method="post">
                            ...
                            if (isset($_POST['simpan'])) {
                                ...
                                $level = $_POST['level'];
                                $status = $_POST['status'];
                                $query = mysqli_query($koneksi, "INSERT INTO user(nama, username, email, no_telepon, level, status) VALUES ('$nama', '$username', '$email', '$no_telepon', '$level', '$status')");
                                if ($query) {
                                    echo /*html*/ "
                                    <script>
                                    ...
                                    location.href='?page=src/user/user_tambah';
                                    </script>";
                                }
                            }
                            ?>
