                    ...
                    <div class="col-md-12">
                        <form action="" method="post">
                                ...
                                if ($query) {
                                    ...
                                    echo /*html*/ "
                                        <script>
                                            ...
                                            location.href='?page=src/peminjaman/peminjaman_ubah&id=$id';
                                        </script>";
                                }
                            }
                            ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="date" name="tanggal_peminjaman" id="tanggal" class="form-control" value="<?php 
                                    $id = $_GET['id'];
                                    $peminjaman = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE id_peminjaman = '$id'"));
                                    echo $peminjaman['tanggal_peminjaman'] ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-2">
