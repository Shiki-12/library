                        ...
                        <form action="" method="post">
                            ...
                            if (isset($_POST['simpan'])) {
                                ...
                                if ($query) {
                                    ...
                                    location.href='?page=src/ulasan/ulasan_ubah';
                                    </script>";
                                }
                            }
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <select name="rating" id="rating" class="form-control">
                                        ...
                                        <?php if ($data['rating'] == $i) echo "selected" ?> >
                                            <?php echo $i ?>
                                        </option>
                                        <?php } ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <button type="submit" name="simpan" class="btn btn-primary" value="submit">
                                        ...
                                        Ubah</button>
                                    <a href="?page=src/ula/ulasan" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg"
